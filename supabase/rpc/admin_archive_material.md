...
Operacion administrativa: archive material.

## Uso desde frontend

- `src/lib/profiles.ts:1843`
...
- `supabase/patch_admin_persistence_config_materials_drafts.sql:207`
- `supabase/patch_beta_baseline.sql:214`
- `supabase/patch_material_author_editing.sql:127`
- `supabase/patch_material_upload_permissions_fix.sql:226`
