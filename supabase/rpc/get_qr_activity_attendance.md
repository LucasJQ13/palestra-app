# RPC: get_qr_activity_attendance
...
Consultar qr activity attendance.

## Uso desde frontend

- `src/lib/profiles.ts:457`
...
Lista `QrActivityAttendanceRecord`
...
- `supabase/patch_qr_activity_lists.sql:274`
