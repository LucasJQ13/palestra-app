...
Operacion remota: respond public query.

## Uso desde frontend

- `src/lib/queries/publicQueries.ts:32`
...
- Parametros: `p_query_id`, `p_response`.
...
- `supabase/migrations/20260612210000_public_queries_inbox.sql:362`
