...
- `supabase/migrations/20260607093000_restrict_admin_tool_permissions.sql:279`
- `supabase/patch_community_leadership_flow.sql:284`
- `supabase/patch_mobile_errors_and_request_roles.sql:42`
- `supabase/patch_news_scope_email_requests_community_coords.sql:230`
- `supabase/patch_requests_and_admin_auth.sql:67`
