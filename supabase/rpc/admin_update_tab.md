...
- Parametros: `p_key`, `p_label`, `p_is_visible`, `p_visible_roles`, `p_icon_name`, `p_section_type`.
...
- `supabase/patch_admin_navigation_manager.sql:24`
- `supabase/patch_admin_rpc_and_tabs.sql:107`
- `supabase/patch_navigation_section_types_deep_link.sql:39`
- `supabase/patch_structural_admin_coherence.sql:4`
