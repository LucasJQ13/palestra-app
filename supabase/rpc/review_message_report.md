...
Operacion remota: review message report.

## Uso desde frontend

- `src/lib/profiles.ts:891`
...
- Parametros: `p_report_id`, `p_status`, `p_action_taken`.
...
- `supabase/migrations/20260607143000_message_moderation.sql:500`
