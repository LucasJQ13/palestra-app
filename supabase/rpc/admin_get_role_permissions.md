# RPC: admin_get_role_permissions
...
Consultar role permissions.

## Uso desde frontend

- `src/lib/profiles.ts:1364`
...
- `supabase/patch_beta_role_permissions_admin.sql:4`
