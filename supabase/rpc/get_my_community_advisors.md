...
Consultar my community advisors.

## Uso desde frontend

- `src/lib/community/advisors.ts:34`
...
- `supabase/migrations/20260613003000_community_advisor_assignments.sql:129`
