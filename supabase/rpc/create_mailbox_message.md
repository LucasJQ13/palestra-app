...
Crear mailbox message.

## Uso desde frontend

- `src/lib/profiles.ts:830`
...
- Parametros: `p_target_mode`, `p_message`, `p_community_id`, `p_province`, `p_role`, `p_user_id`.
...
- `supabase/patch_beta_functional_stability.sql:594`
