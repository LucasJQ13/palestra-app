# RPC: mark_prayer_removal_notices_seen
...
Operacion remota: mark prayer removal notices seen.

## Uso desde frontend

- `src/lib/profiles.ts:1340`
...
- `prayer_intention_removal_notices` (detectada en SQL versionado).

## Referencias SQL versionadas

- `supabase/patch_prayer_intentions.sql:468`
