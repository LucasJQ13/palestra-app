# RPC: admin_set_community_status
...
Operacion administrativa: set community status.

## Uso desde frontend

- `src/lib/profiles.ts:2192`
...
- Parametros: `p_community_id`, `p_is_active`.
...
- `supabase/migrations/20260606100000_restrict_community_leader_admin_permissions.sql:204`
- `supabase/patch_community_management_scope.sql:216`
