...
Operacion remota: restrict user messaging.

## Uso desde frontend

- `src/lib/profiles.ts:903`
...
- Parametros: `p_user_id`, `p_reason`, `p_days`.
...
- `user_messaging_restrictions` (detectada en SQL versionado).

## Referencias SQL versionadas

- `supabase/migrations/20260607143000_message_moderation.sql:541`
