# RPC: admin_restore_default_tabs
...
Operacion administrativa: restore default tabs.

## Uso desde frontend

- `src/lib/profiles.ts:1573`
...
- `supabase/patch_admin_navigation_manager.sql:167`
- `supabase/patch_navigation_section_types_deep_link.sql:189`
