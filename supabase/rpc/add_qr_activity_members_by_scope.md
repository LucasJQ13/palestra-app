# RPC: add_qr_activity_members_by_scope
...
Operacion remota: add qr activity members by scope.

## Uso desde frontend

- `src/lib/profiles.ts:480`
...
- Parametros: `p_list_id`, `p_province`, `p_community_name`.
...
- `supabase/patch_qr_activity_lists.sql:331`
