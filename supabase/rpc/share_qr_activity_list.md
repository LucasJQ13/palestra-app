...
Operacion remota: share qr activity list.

## Uso desde frontend

- `src/lib/profiles.ts:421`
...
- Parametros: `p_list_id`, `p_user_ids`, `p_roles`.
...
- `qr_activity_list_shares` (detectada en SQL versionado).

## Referencias SQL versionadas

- `supabase/patch_qr_activity_lists.sql:150`
