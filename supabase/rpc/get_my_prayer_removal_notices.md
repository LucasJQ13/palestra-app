# RPC: get_my_prayer_removal_notices
...
Consultar my prayer removal notices.

## Uso desde frontend

- `src/lib/profiles.ts:1328`
...
Lista `PrayerRemovalNoticeRecord`
...
- `supabase/patch_prayer_intentions.sql:448`
