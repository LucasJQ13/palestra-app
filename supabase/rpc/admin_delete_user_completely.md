...
Operacion administrativa: delete user completely.

## Uso desde frontend

- `src/lib/profiles.ts:1108`
...
- `admin_delete_user_by_email` (detectada en SQL versionado).

## Referencias SQL versionadas

- `supabase/patch_safe_user_delete_diagnostics.sql:236`
- `supabase/patch_user_auth_cleanup_v2.sql:506`
- `supabase/patch_user_delete_foreign_keys.sql:204`
