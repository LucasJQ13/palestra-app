# RPC: accept_coordinator_request
...
Operacion remota: accept coordinator request.

## Uso desde frontend

- `src/lib/profiles.ts:992`
...
- `supabase/patch_beta_coordinator_acceptance.sql:86`
- `supabase/patch_national_coordinator_replacement.sql:98`
