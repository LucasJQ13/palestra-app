...
Operacion remota: restore message for me.

## Uso desde frontend

- `src/lib/profiles.ts:959`
...
- Parametros: `p_message_id`, `p_source`.
...
- `supabase/migrations/20260606010000_direct_user_messaging.sql:382`
