# RPC: create_community_contact_message
...
Crear community contact message.

## Uso desde frontend

- `src/lib/profiles.ts:784`
...
- Parametros: `p_community_id`, `p_sender_name`, `p_sender_contact`, `p_message`.
...
- `supabase/migrations/20260612210000_public_queries_inbox.sql:163`
- `supabase/patch_community_mailbox.sql:68`
