# RPC: admin_set_province_community_section
...
Operacion administrativa: set province community section.

## Uso desde frontend

- `src/lib/profiles.ts:2126`
...
- Parametros: `p_province`, `p_group_type`, `p_is_enabled`.
...
- `province_community_sections` (detectada en SQL versionado).
- `provinces` (detectada en SQL versionado).

## Referencias SQL versionadas

- `supabase/patch_community_subsections.sql:73`
