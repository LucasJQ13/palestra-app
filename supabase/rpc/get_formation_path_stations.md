# RPC: get_formation_path_stations
...
Consultar formation path stations.

## Uso desde frontend

- `src/lib/profiles.ts:1757`
...
- Parametros: `p_include_inactive`.

## Respuesta esperada

Lista `FormationPathStationRecord`
...
- `supabase/migrations/20260606124000_formation_path_section.sql:79`
- `supabase/migrations/20260607093000_restrict_admin_tool_permissions.sql:52`
