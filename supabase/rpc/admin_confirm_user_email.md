...
Operacion administrativa: confirm user email.

## Uso desde frontend

- `src/lib/profiles.ts:1008`
...
- Parametros: `p_user_id`.

## Respuesta esperada

Mutacion; fallback de Edge Function
...
- `supabase/patch_admin_users.sql:83`
- `supabase/patch_beta_functional_stability.sql:485`
