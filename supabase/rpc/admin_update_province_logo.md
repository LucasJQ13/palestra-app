# RPC: admin_update_province_logo
...
Actualizar province logo.

## Uso desde frontend

- `src/lib/profiles.ts:2160`
...
- `supabase/patch_province_logo_status_admin.sql:59`
