# RPC: archive_community_publication
...
Operacion remota: archive community publication.

## Uso desde frontend

- `src/lib/remoteData.ts:424`
...
- `supabase/patch_beta_functional_stability.sql:884`
