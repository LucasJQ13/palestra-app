...
Operacion remota: react to publication.

## Uso desde frontend

- `src/lib/remoteData.ts:616`
...
- Parametros: `p_publication_id`, `p_reaction`.
...
- `publication_reactions` (detectada en SQL versionado).

## Referencias SQL versionadas

- `supabase/migrations/20260612193000_enriched_community_notices.sql:507`
- `supabase/patch_forum_comments_reactions.sql:253`
