# RPC: admin_set_motivador_period_status
...
Operacion administrativa: set motivador period status.

## Uso desde frontend

- `src/lib/profiles.ts:1967`
...
- `supabase/patch_motivador_management.sql:295`
