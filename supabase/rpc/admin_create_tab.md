...
- Parametros: `p_key`, `p_label`, `p_visible_roles`, `p_icon_name`, `p_section_type`.
...
- `supabase/patch_admin_navigation_manager.sql:61`
- `supabase/patch_navigation_section_types_deep_link.sql:88`
- `supabase/patch_structural_admin_coherence.sql:35`
