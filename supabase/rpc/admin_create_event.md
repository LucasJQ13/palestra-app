...
- Parametros: `p_title`, `p_description`, `p_starts_at`, `p_is_public`.
...
- `supabase/patch_admin_rpc_and_tabs.sql:76`
- `supabase/patch_beta_content_permissions.sql:113`
