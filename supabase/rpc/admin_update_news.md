...
- `src/lib/remoteData.ts:308`
- `src/lib/remoteData.ts:321`
...
- Parametros: `p_news_id`, `p_title`, `p_body`, `p_image_url`, `p_is_public`.
...
- `supabase/patch_news_optional_images.sql:80`
- `supabase/patch_published_content_management.sql:26`
