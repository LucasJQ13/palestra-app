# RPC: respond_community_contact_message
...
Operacion remota: respond community contact message.

## Uso desde frontend

- `src/lib/profiles.ts:970`
...
- Parametros: `p_message_id`, `p_response`.
...
- `supabase/patch_beta_functional_stability.sql:768`
- `supabase/patch_community_mailbox.sql:183`
