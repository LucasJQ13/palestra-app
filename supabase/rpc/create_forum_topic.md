...
- Parametros: `p_category_id`, `p_title`, `p_body`, `p_min_role`.
...
- `supabase/patch_forum_scope_rules.sql:128`
- `supabase/patch_forum_topics.sql:161`
- `supabase/patch_public_profile_and_forum_fix.sql:75`
