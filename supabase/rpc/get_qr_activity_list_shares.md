# RPC: get_qr_activity_list_shares
...
Consultar qr activity list shares.

## Uso desde frontend

- `src/lib/profiles.ts:433`
...
Lista `QrActivityListShareRecord`
...
- `supabase/patch_qr_activity_lists.sql:175`
