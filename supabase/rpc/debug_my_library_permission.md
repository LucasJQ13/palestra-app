# RPC: debug_my_library_permission
...
Operacion remota: debug my library permission.

## Uso desde frontend

- `src/lib/library.ts:85`
...
Registro `LibraryPermissionDebug`
...
- `supabase/patch_library_publish_permissions_fix.sql:211`
