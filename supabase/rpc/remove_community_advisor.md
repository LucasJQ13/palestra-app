...
Operacion remota: remove community advisor.

## Uso desde frontend

- `src/lib/community/advisors.ts:52`
...
- `supabase/migrations/20260613003000_community_advisor_assignments.sql:284`
