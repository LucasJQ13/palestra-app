# RPC: admin_set_formation_path_station_status
...
Operacion administrativa: set formation path station status.

## Uso desde frontend

- `src/lib/profiles.ts:1794`
...
- Parametros: `p_station_id`, `p_is_active`.
...
- `supabase/migrations/20260606124000_formation_path_section.sql:257`
- `supabase/migrations/20260607093000_restrict_admin_tool_permissions.sql:233`
