...
Consultar my public queries.

## Uso desde frontend

- `src/lib/queries/publicQueries.ts:13`
...
- `supabase/migrations/20260612210000_public_queries_inbox.sql:272`
