...
Operacion remota: remove qr activity member.

## Uso desde frontend

- `src/lib/profiles.ts:492`
...
- Parametros: `p_list_id`, `p_user_id`.
...
- `supabase/patch_qr_activity_lists.sql:357`
