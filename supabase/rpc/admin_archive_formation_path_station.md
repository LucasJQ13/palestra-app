# RPC: admin_archive_formation_path_station
...
Operacion administrativa: archive formation path station.

## Uso desde frontend

- `src/lib/profiles.ts:1805`
...
- `supabase/migrations/20260606124000_formation_path_section.sql:279`
- `supabase/migrations/20260607093000_restrict_admin_tool_permissions.sql:255`
