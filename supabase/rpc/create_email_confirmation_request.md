# RPC: create_email_confirmation_request
...
Crear email confirmation request.

## Uso desde frontend

- `src/lib/profiles.ts:708`
...
- Parametros: `p_user_id`, `p_email`, `p_full_name`, `p_province`, `p_community_name`, `p_contact`.
...
- `supabase/patch_news_scope_email_requests_community_coords.sql:180`
