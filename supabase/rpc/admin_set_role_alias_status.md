# RPC: admin_set_role_alias_status
...
Operacion administrativa: set role alias status.

## Uso desde frontend

- `src/lib/profiles.ts:1421`
...
- Parametros: `p_alias_id`, `p_is_active`.
...
- `supabase/patch_community_images_dynamic_roles.sql:300`
