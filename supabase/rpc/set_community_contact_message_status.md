# RPC: set_community_contact_message_status
...
Operacion remota: set community contact message status.

## Uso desde frontend

- `src/lib/profiles.ts:981`
...
- Parametros: `p_message_id`, `p_status`.
...
- `supabase/patch_community_mailbox.sql:232`
