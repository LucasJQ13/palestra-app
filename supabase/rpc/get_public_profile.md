...
Consultar public profile.

## Uso desde frontend

- `src/lib/profiles.ts:764`
...
- `supabase/patch_email_confirmation_and_personal_pm.sql:311`
- `supabase/patch_profile_perseverance_preferences.sql:328`
- `supabase/patch_public_profile_and_forum_fix.sql:1`
- `supabase/patch_public_profile_gender_labels.sql:6`
