...
Operacion remota: assign community advisor.

## Uso desde frontend

- `src/lib/community/advisors.ts:45`
...
- Parametros: `p_community_id`, `p_advisor_user_id`.
...
- `supabase/migrations/20260613003000_community_advisor_assignments.sql:192`
