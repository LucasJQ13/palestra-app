...
Operacion administrativa: archive community.

## Uso desde frontend

- `src/lib/profiles.ts:2203`
...
- `supabase/migrations/20260606100000_restrict_community_leader_admin_permissions.sql:239`
- `supabase/patch_community_management_scope.sql:241`
