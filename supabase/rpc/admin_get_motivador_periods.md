# RPC: admin_get_motivador_periods
...
Consultar motivador periods.

## Uso desde frontend

- `src/lib/profiles.ts:1917`
...
- `supabase/patch_motivador_management.sql:79`
