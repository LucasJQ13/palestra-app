# RPC: create_institutional_query
...
Crear institutional query.

## Uso desde frontend

- `src/lib/queries/publicQueries.ts:42`
...
- Parametros: `p_target_user_id`, `p_sender_name`, `p_sender_contact`, `p_message`, `p_origin`.
...
- `supabase/migrations/20260612210000_public_queries_inbox.sql:182`
