...
Consultar admin config.

## Uso desde frontend

- `src/lib/profiles.ts:1701`
...
Registro JSON `AdminConfigRecord`

## Tablas afectadas o consultadas

- `admin_config` (detectada en SQL versionado).

## Referencias SQL versionadas

- `supabase/patch_admin_persistence_config_materials_drafts.sql:103`
