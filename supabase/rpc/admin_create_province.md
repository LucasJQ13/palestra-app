...
- `src/lib/profiles.ts:2138`
- `src/lib/profiles.ts:2149`
...
- Parametros: `p_name`, `p_region`, `p_logo_url`.
...
- `supabase/patch_create_provinces.sql:4`
- `supabase/patch_province_logo_status_admin.sql:9`
