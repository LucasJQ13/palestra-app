...
Consultar public user directory.

## Uso desde frontend

- `src/lib/profiles.ts:535`
...
Lista `PublicUserDirectoryRecord`
...
- `supabase/patch_public_user_directory.sql:6`
