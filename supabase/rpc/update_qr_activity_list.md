...
Actualizar qr activity list.

## Uso desde frontend

- `src/lib/profiles.ts:398`
...
- Parametros: `p_list_id`, `p_title`, `p_province`, `p_community_name`.
...
- `supabase/patch_qr_activity_lists.sql:211`
