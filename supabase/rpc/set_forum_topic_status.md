...
Operacion remota: set forum topic status.

## Uso desde frontend

- `src/lib/forum.ts:199`
...
- Parametros: `p_topic_id`, `p_status`.
...
- `supabase/patch_forum_topics.sql:238`
