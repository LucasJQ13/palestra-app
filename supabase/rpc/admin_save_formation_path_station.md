# RPC: admin_save_formation_path_station
...
Operacion administrativa: save formation path station.

## Uso desde frontend

- `src/lib/profiles.ts:1771`
...
- Parametros: `p_id`, `p_title`, `p_subtitle`, `p_short_description`, `p_image_url`, `p_icon_name`, `p_color`, `p_sort_order`, `p_young_content`, `p_leader_content`, `p_visible_roles`, `p_is_active`, `p_material_ids`.
...
- `formation_path_station_materials` (detectada en SQL versionado).
- `formation_path_stations` (detectada en SQL versionado).

## Referencias SQL versionadas

- `supabase/migrations/20260606124000_formation_path_section.sql:150`
- `supabase/migrations/20260606125500_fix_formation_path_station_id_ambiguity.sql:1`
- `supabase/migrations/20260607093000_restrict_admin_tool_permissions.sql:126`
