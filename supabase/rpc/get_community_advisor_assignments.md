# RPC: get_community_advisor_assignments
...
Consultar community advisor assignments.

## Uso desde frontend

- `src/lib/community/advisors.ts:19`
...
- Parametros: `p_community_id`.

## Respuesta esperada

Lista `CommunityAdvisorAssignment`

## Tablas afectadas o consultadas

- `communities` (detectada en SQL versionado).
- `community_advisors` (detectada en SQL versionado).
- `profiles` (detectada en SQL versionado).
- `provinces` (detectada en SQL versionado).

## Referencias SQL versionadas

- `supabase/migrations/20260613003000_community_advisor_assignments.sql:49`
