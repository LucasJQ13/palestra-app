...
Operacion remota: report publication.

## Uso desde frontend

- `src/lib/remoteData.ts:632`
...
- Parametros: `p_publication_id`, `p_reason`.
...
- `publication_reports` (detectada en SQL versionado).

## Referencias SQL versionadas

- `supabase/patch_forum_comments_reactions.sql:282`
