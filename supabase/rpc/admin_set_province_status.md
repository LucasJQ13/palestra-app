...
Operacion administrativa: set province status.

## Uso desde frontend

- `src/lib/profiles.ts:2171`
...
- `supabase/patch_province_logo_status_admin.sql:94`
