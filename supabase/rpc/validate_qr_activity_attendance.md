# RPC: validate_qr_activity_attendance
...
Operacion remota: validate qr activity attendance.

## Uso desde frontend

- `src/lib/profiles.ts:503`
...
- Parametros: `p_list_id`, `p_token`.

## Respuesta esperada

Registro de validacion/asistencia; forma pendiente

## Tablas afectadas o consultadas

- `qr_activity_attendance` (detectada en SQL versionado).
- `qr_activity_lists` (detectada en SQL versionado).
- `qr_activity_members` (detectada en SQL versionado).
- `validate_profile_credential` (detectada en SQL versionado).

## Referencias SQL versionadas

- `supabase/patch_qr_activity_lists.sql:372`
