...
Actualizar forum topic.

## Uso desde frontend

- `src/lib/forum.ts:186`
...
- Parametros: `p_topic_id`, `p_title`, `p_body`, `p_min_role`.
...
- `supabase/patch_forum_scope_rules.sql:168`
- `supabase/patch_forum_topics.sql:203`
