...
export function CommunityAdminPanel({
  ...
  return (
    <View style={[styles.adminWorkspace, isDark && styles.adminWorkspaceDark]}>
      ...
      <Text style={styles.cardText}>Crear, editar, habilitar, deshabilitar o archivar comunidades según tu jurisdicción.</Text>
      ...
      {canAdministrateCommunities && selectedAdminProvince && showAdminCommunityCreate ? (
        <View style={styles.profileCommunityPanel}>
          ...
          <TextInput style={styles.input} placeholder="Nombre de comunidad" value={adminCommunityId ? '' : adminCommunityName} onChangeText={(value) => { onResetSelectedCommunity(); setAdminCommunityName(value); }}  placeholderTextColor={inputPlaceholderColor} />
          ...
          <View style={styles.filterRow}>
            <TextInput style={[styles.input, styles.colorInput]} placeholder="Direccion" value={adminCommunityId ? '' : adminCommunityAddress} onChangeText={(value) => { onResetSelectedCommunity(); setAdminCommunityAddress(value); }}  placeholderTextColor={inputPlaceholderColor} />
            <TextInput style={[styles.input, styles.colorInput]} placeholder="Contacto" value={adminCommunityId ? '' : adminCommunityPhone} onChangeText={(value) => { onResetSelectedCommunity(); setAdminCommunityPhone(value); }}  placeholderTextColor={inputPlaceholderColor} />
          </View>
          <View style={styles.filterRow}>
            <TextInput style={[styles.input, styles.colorInput]} placeholder="Dia de reunion" value={adminCommunityId ? '' : adminCommunityDay} onChangeText={(value) => { onResetSelectedCommunity(); setAdminCommunityDay(value); }}  placeholderTextColor={inputPlaceholderColor} />
            <TextInput style={[styles.input, styles.colorInput]} placeholder="Horario" value={adminCommunityId ? '' : adminCommunityTime} onChangeText={(value) => { onResetSelectedCommunity(); setAdminCommunityTime(value); }}  placeholderTextColor={inputPlaceholderColor} />
          </View>
          <View style={styles.filterRow}>
          ...
          <TextInput style={[styles.input, styles.textArea]} placeholder="Descripción" value={adminCommunityId ? '' : adminCommunityDescription} onChangeText={(value) => { onResetSelectedCommunity(); setAdminCommunityDescription(value); }} multiline  placeholderTextColor={inputPlaceholderColor} />
                ...
                <View key={itemKey}>
                  ...
                  {selected ? (
                    <View style={styles.adminInlineEditor}>
                      ...
                      <View style={styles.profileCommunityPanel}>
                        <Text style={styles.cardEyebrow}>Ubicación</Text>
                        ...
                        <TouchableOpacity style={styles.secondaryButton} onPress={() => Linking.openURL(`https://www.google.com/maps/search/?api=1&query=${encodeURIComponent(`${adminCommunityAddress}, ${adminCommunityProvince}, Argentina`)}`)}>
                          ...
                          <Text style={styles.secondaryButtonText}>Ver dirección en Maps</Text>
                        </TouchableOpacity>
                      </View>
                      <TextInput style={[styles.input, styles.textArea]} placeholder="Descripción e historia" value={adminCommunityDescription} onChangeText={setAdminCommunityDescription} multiline  placeholderTextColor={inputPlaceholderColor} />
