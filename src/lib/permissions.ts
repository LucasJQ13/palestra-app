...
export const rolePermissions: Record<Role, Permission[]> = {
  ...
  vocal: [...basePermissions, 'ver_materiales_internos', 'descargar_archivos', 'descargar_archivos_exclusivos', 'ver_fechas_privadas', 'ver_noticias_comunidad', 'aprobar_sedimentadores', 'otorgar_roles_provincia', 'gestionar_contenido'],
  coordinador_diocesano: [...basePermissions, 'ver_materiales_internos', 'descargar_archivos', 'descargar_archivos_exclusivos', 'ver_fechas_privadas', 'ver_noticias_comunidad', 'aprobar_sedimentadores', 'otorgar_roles_provincia', 'otorgar_roles_diocesanos', 'gestionar_contenido'],
  asesor: [...basePermissions, 'ver_materiales_internos', 'descargar_archivos', 'descargar_archivos_exclusivos', 'ver_fechas_privadas', 'ver_noticias_comunidad', 'ver_seccion_asesores', 'gestionar_comunidad'],
  vocal_nacional: [...basePermissions, 'ver_materiales_internos', 'descargar_archivos', 'descargar_archivos_exclusivos', 'ver_fechas_privadas', 'ver_noticias_comunidad', 'gestionar_contenido', 'enviar_notificaciones'],
  coordinador_nacional: [...basePermissions, 'ver_materiales_internos', 'descargar_archivos', 'descargar_archivos_exclusivos', 'ver_fechas_privadas', 'ver_noticias_comunidad', 'gestionar_contenido', 'gestionar_permisos', 'enviar_notificaciones'],
