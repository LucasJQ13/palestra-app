...
import { Animated, Easing, Image, KeyboardAvoidingView, Modal, Platform, RefreshControl, ScrollView, StatusBar, Text, TextInput, ToastAndroid, TouchableOpacity, useWindowDimensions, View } from 'react-native';
...
import { news, notilestra } from './src/data/content';
...
import { fetchCommunityPublications } from './src/lib/remoteData';
import { roleRank } from './src/lib/roles';
import { canAccessPrivate, canEditPageContent, canManageUsersPanel, isCommunityLeaderRole } from './src/lib/sessionAccess';
...
import { ContactScreen, HistoryScreen, MaintenanceScreen } from './src/screens/StaticScreens';
import { styles } from './src/theme/appStyles';
import { palette } from './src/theme/palette';
import { AppThemeContext } from './src/theme/ThemeContext';
import { AppTheme, themePresets } from './src/theme/themes';
import { ProfilePanel } from './src/types/appUi';
import { Role, Session } from './src/types/auth';
...
export default function App() {
  ...
  const showToastError = useCallback((message: string = APP_MESSAGES.saveFailed) => {
    setAppMessage(message);
